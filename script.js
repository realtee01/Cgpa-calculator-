document.addEventListener('DOMContentLoaded', () => {
    ...
    function createRow() {
        ...
        tr.innerHTML = `
            <td class="px-6 py-4">
                <input type="text" placeholder="e.g. CSC 301" class="w-full bg-transparent border-none focus:outline-none text-slate-700 dark:text-slate-200 font-medium placeholder:text-slate-300">
            </td>
            <td class="px-6 py-4">
                <input type="number" placeholder="0" class="unit-input w-16 mx-auto block bg-slate-100 dark:bg-slate-800 rounded-md p-2 text-center font-bold text-indigo-600 dark:text-indigo-400 outline-none">
            </td>
            <td class="px-6 py-4">
                <select class="grade-input w-20 mx-auto block bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 rounded-md p-2 font-semibold outline-none cursor-pointer">
